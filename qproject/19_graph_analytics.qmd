...
![Anonymous vertexes and edges](images/19_graph_analytics/motif_anonyomous_vertexes.png){width=80%}
...
![Negating edges](images/19_graph_analytics/motif_negating_edges.png){width=80%}
...
![Example graph](images/19_graph_analytics/motif_finding_example_1.png){width=80%}
...
![Result](images/19_graph_analytics/motif_finding_example_2.png){width=80%}
...
![First selected path](images/19_graph_analytics/motif_finding_example_3.png){width=80%}

![Second selected path](images/19_graph_analytics/motif_finding_example_4.png){width=80%}
...
![First selected vertex](images/19_graph_analytics/motif_finding_example_5.png){width=80%}

![Second selected vertex](images/19_graph_analytics/motif_finding_example_6.png){width=80%}

![Resulting vertexes](images/19_graph_analytics/motif_finding_example_7.png){width=80%}
