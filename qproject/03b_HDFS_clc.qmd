---
title: "HDFS and Hadoop: command line commands"
---
...
<p style="text-align: center;">`hdfs dfs -ls folder`</p>
...
<p style="text-align: center;">`hdfs dfs -cat file_name`</p>
...
<p style="text-align: center;">`hdfs dfs -put local_file HDFS_path`</p>
...
<p style="text-align: center;">`hdfs dfs -get HDFS_path local_file`</p>
...
<p style="text-align: center;">`hdfs dfs -rm HDFS_path`</p>
